...
public class KauppaTest {
    ...
    @Test
    public void kaksiEriOstostaTehtyPankinMetodiaTilisiirtoKutsutaanOikeillaParametreilla() {
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void ostostenJotaOnJaEiOleJalkeenMetodiaTilisiirtoKutsutaanOikeillaParametreilla() {
        Pankki pankki = mock(Pankki.class);
        ...
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.haeTuote(2)).thenReturn(new Tuote(0, "piima", 6));
