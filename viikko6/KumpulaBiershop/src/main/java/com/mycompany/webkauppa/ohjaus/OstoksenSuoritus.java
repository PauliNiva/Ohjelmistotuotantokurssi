...
public class OstoksenSuoritus implements Komento {
    ...
    OstoksenSuoritus(String nimi, String osoite, String luottokorttinumero, Ostoskori kori, PankkiFasaadi pankki, Varasto varasto, ToimitusjarjestelmaFasaadi toimitusjarjestelma) {
